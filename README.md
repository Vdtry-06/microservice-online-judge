...
- Then upload file [Judge-Online Structure](judge-online.json)
...
|Judge Worker|Java 21+ or nodejs 18+| springboot, express, amqplib, ioredis|N/A|
...
## DB, RabbitMQ, UI:
1. problems: http://localhost:8081
![alt text](source/static/problem.png)
2. submissions: http://localhost:8082
![alt text](source/static/submission.png)
3. users: http://localhost:8083
![alt text](source/static/user.png)
4. rabbitmq: http://localhost:15672
![alt text](source/static/rabbitmq.png)
5. Login : http://localhost
![alt text](source/static/login.png)
![alt text](source/static/register.png)
6. Home : http://localhost/home
![alt text](source/static/home.png)
7. problems: http://localhost/problems
![alt text](source/static/problems.png)
8. problem detail: http://localhost/problem/</id>
![alt text](source/static/problem-detail.png)
9. check, test, submit
![alt text](source/static/submit1.png)
![alt text](source/static/submit2.png)
10. leaderboard: http://localhost/leaderboard
![alt text](source/static/leaderboard.png)

## Testing
1. cd source/server/load-testing
2. npm install node
3. MAX_USERS=1000 node load-test.js
![alt text](source/static/test1000user.png)
- Hiện tại chưa tối ưu và đang chia 5 worker tốc độ xử lý xong 1000 user submit cùng lúc là 30s và accept hết.
- vẫn có thể tối ưu hơn

- ![alt text](source/static/log.png)
- Đây là log 1 trong 5 worker xử lý

4. MAX_USERS=10000 node load-test.js
![alt text](source/static/test10000user1.png)
![alt text](source/static/test10000user2.png)
- Hiện tại tốc độ xử lý 10000 user successful là 90s có thể tối ưu thêm